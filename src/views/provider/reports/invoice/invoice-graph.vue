...
import ApexChartInvocieBalance from '@/views/provider/reports/invoice/ApexChartInoviceBalance.vue';
...
<template>
  <VCard>
    <VCardItem :title="$t('Invoice statistics')" subtitle="">
    </VCardItem>

    <VCardText>
      <ApexChartInvocieBalance />
    </VCardText>
  </VCard>
</template>
