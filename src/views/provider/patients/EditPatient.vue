...
<template>
    <VNavigationDrawer temporary :width="800" location="end" class="scrollable-content"
        ...
        <AppDrawerHeaderSection title="Edit Patient Profile" @cancel="closeNavigationDrawer" />
            ...
            <VCard flat>
                <VCardText>
                    <VTabs v-model="currentTab" class="v-tabs-pill">
                        ...
                        <VTab>{{ $t('Next of Kin') }}</VTab>
                        <VTab>{{ $t('Insurance') }}</VTab>
                    ...
                    <VCardText>
                        <VWindow v-model="currentTab">
                            <VWindowItem key="1">
                                <Demographic @patientData=updateNewUser @customEvent="closeNavigationDrawer" />
                            </VWindowItem>
                            <VWindowItem key="2">
                                <NextOfKin @patientData=updateNewUser @customEvent="closeNavigationDrawer" />
                            </VWindowItem>
                            <VWindowItem key="3">
                                <Insurance @patientData=updateNewUser @customEvent="closeNavigationDrawer" />
                            </VWindowItem>
                            <!-- <VWindowItem
                  key="4"
                >
