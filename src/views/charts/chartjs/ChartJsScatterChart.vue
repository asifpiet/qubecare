...
const data = scatterhartData(props.colors);
</script>
<script>
export function scatterhartData(colors) {
  const data = {
  datasets: [
    {
      pointRadius: 5,
    ...
    },
    {
      ...
      pointBorderWidth: 2,
      label: 'Samsung Note',
      backgroundColor: colors.scatterChartWarning,
      pointHoverBorderWidth: 2,
      borderColor: 'transparent',
      data: [
        {
    ...
    },
    {
      ...
      label: 'OnePlus',
      pointBorderWidth: 2,
      backgroundColor: colors.scatterChartGreen,
      pointHoverBorderWidth: 2,
      borderColor: 'transparent',
      data: [
        {
