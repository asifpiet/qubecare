...
onBeforeMount(async () => {
  ...
  let buildersRes = await $api(GET_PROVIDER_BUILDERS+'/'+userData.value?.id, {
                            method: 'GET',
...
<template>
  ...
  >
    ...
    <AppDrawerHeaderSection
      title="Add To Affiliate Network"
          ...
          <VCardText>
            <v-form ref="refForm" >
                <v-row>
                    ...
                    <v-col cols="12" md="12">
                    <v-select
                        v-model="selectBuilderId"
                        :items="builders"
                        label="Builder"
                        outlined
                        required
                        item-title="builder_name"
                        item-value="builder_id"
                    ></v-select>
                    </v-col>
                    <v-col cols="12" md="12">
                    <VTextField
