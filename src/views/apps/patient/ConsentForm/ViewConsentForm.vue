...
onMounted(async () => {
    ...
    await store.dispatch('getPatientConsentFormData',{
        id:store.getters.getPatientConsentFormId,
        uuid: store.getters.getPatientPorfile.uuid
    });
    storedData.value = store.getters.getPatientConsentFormData
    ...
    tempData = setFieldValues(patientConsentFormItem.data,jsonConvert(deepToRaw(store.getters.getConsentFormData.data)))
        ...
        <VCardText>   -->
            <form ref="consentForm" @submit.prevent="submitForm">
                <VRow>  
                    ...
                    <VCol cols="12"><img :src="signature"/></VCol>
