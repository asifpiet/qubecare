<script setup>
// import PatientInsuraceCoverage from '@/views/apps/user/edit/PatientInsuraceCoverage.vue';
import { useStore } from 'vuex';
const store = useStore()
const isFormValid = ref(false)
const isLoading = ref(false)
const dataType = ref('update-insurance');
const refForm = ref()
...
const showEditData = computed(() =>{
  console.log("getPatientProfile",store.getters.getPatientIsursance);
  let patient = store.getters.getPatientIsursance;
  if(patient){
    insurance.value = store.getters.getPatientIsursance.insuredPlanOrProgramName
    insuredPlanOrProgramName.value = store.getters.getPatientIsursance.insuredPlanOrProgramName
    insuredIDNumber.value =  store.getters.getPatientIsursance.insuredIDNumber
    insuredGroupNameNo.value = store.getters.getPatientIsursance.insuredGroupNameNo
    employersSchoolName.value = patient.employersSchoolName
    relationshiptoInsured.value = patient.relationshiptoInsured
    insuredName.value = patient.insuredName
    insuredDateOfBirth.value = patient.insuredDateOfBirth
    insuredGender.value = patient.insuredGender;
    coPayment.value = store.getters.getPatientIsursance.coPayment
    coInsurance.value = store.getters.getPatientIsursance.coInsurance
    insuranceDeductible.value =  store.getters.getPatientIsursance.insuranceDeductible
    insuredAddress.value = store.getters.getPatientIsursance.insuredAddress
    insuredCity.value = patient.insuredCity
    insuredState.value = patient.insuredState
    insuredZip.value = patient.insuredZip
    insuredPhone.value = patient.insuredPhone
    payerName.value = patient.payerName;
    payerID.value = store.getters.getPatientIsursance.payerID
    payerAddress.value = store.getters.getPatientIsursance.payerAddress
    payerCity.value =  store.getters.getPatientIsursance.payerCity
    payerState.value = store.getters.getPatientIsursance.payerState
    payerZip.value = patient.payerZip
    referringProviderName.value = patient.referringProviderName
    referringProviderNPI.value = patient.referringProviderNPI
    referringProviderTaxonomy.value = patient.referringProviderTaxonomy
    uuid.value = patient.uuid;
...
const onSubmit = (trigger) => {
  ...
  refForm.value?.validate().then(({ valid }) => {
    if (valid) {
      ...
      insurance:insuredPlanOrProgramName.value,
