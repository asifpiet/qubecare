...
const showEditData = computed(() =>{
  ...
  if(patient){
    secInsurance.value = store.getters.getPatientPorfile.secInsurance
    secInsuredPlanORProgramName.value = store.getters.getPatientPorfile.secInsuredPlanORProgramName
    secInsuredIDNumber.value =  store.getters.getPatientPorfile.secInsuredIDNumber
    secInsuredGroupNameNo.value = store.getters.getPatientPorfile.secInsuredGroupNameNo
    secEmployersSchoolName.value = store.getters.getPatientPorfile.secEmployersSchoolName
    secRelationshipToInsured.value = patient.secRelationshipToInsured
    secInsuredName.value = patient.secInsuredName
    secInsuredDateOfBirth.value = patient.secInsuredDateOfBirth
    secGender.value = patient.secGender
    secInsuredAddress.value = patient.secInsuredAddress;
    secInsuredCity.value = store.getters.getPatientPorfile.secInsuredCity
    secSelectState.value = store.getters.getPatientPorfile.secSelectState
    secInsuredZip.value =  store.getters.getPatientPorfile.secInsuredZip
    secInsuredPhone.value = patient.secInsuredPhone
    secPayerName.value = patient.secPayerName
    secPayerID.value = patient.secPayerID
    secPayerAddress.value = patient.secPayerAddress
    secPayerCity.value = patient.secPayerCity
    secPayerState.value = patient.secPayerState;
    secZip.value = store.getters.getPatientPorfile.secZip
  }
})
