...
<template>
  <VForm ref="refForm" v-model="isFormValid">
    <VRow>
      ...
      <VCol cols="4">
        <AppTextField  type="number"  v-model="weight_oz" :label="$t('Weight (oz)')" :placeholder="$t('Weight (oz)')" :rules="[requiredValidator]" />
      </VCol>
      ...
      <VCol cols="4">
        <AppTextField  type="number" v-model="height_ft" :label="$t('Height (ft)')"  :placeholder="$t('Height (ft)')"  :rules="[requiredValidator]" />
      </VCol>
      <VCol cols="4">
        <AppTextField type="number"  v-model="height_in"  :label="$t('Height (In)')"  :placeholder="$t('Height (In)')"  :rules="[requiredValidator]" />
      </VCol>
      <VCol cols="4">
        <AppTextField  type="number" v-model="ibm" :label="$t('Respiratory Rate (RPM)')"  :placeholder="$t('Respiratory Rate (RPM)')"  :rules="[requiredValidator]" />
      </VCol>
      <VCol cols="6">
        <AppTextField v-model="blood_presssure" :label="$t('Blood Pressure (Systolic) mmHg')" 
          :placeholder="$t('Blood Pressure (Systolic) mmHg')" :rules="[requiredValidator]" />
      </VCol>
