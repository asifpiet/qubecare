...
<template>
  ...
  <PerfectScrollbar :options="{ wheelPropagation: false }">
    ...
    <DataTable ref="dataTable" cardTitle="" btnTitle="New Vital" :headers="headers"
    ...
    <VNavigationDrawer v-model="isVitalDialogVisible" temporary :width="800" location="end" class="scrollable-content">
      <AppDrawerHeaderSection :title='"Create Vital (" + props.patient.demographic.fullName + ")"'
    ...
    <VNavigationDrawer v-model="isEditVitalDialogVisible" temporary :width="800" location="end"
      ...
      <AppDrawerHeaderSection :title='"Edit Vital (" + props.patient.demographic.fullName + ")"'
