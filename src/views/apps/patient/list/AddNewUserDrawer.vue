...
<template>
  ...
  <VNavigationDrawer temporary :width="800" location="end" class="scrollable-content" :model-value="props.isDrawerOpen"
    ...
    <AppDrawerHeaderSection title="Add Patient Profile" @cancel="closeNavigationDrawer" />
        ...
        <VCardText>
          ...
          <VCardText>
            <VWindow v-model="currentTab">
              <VWindowItem key="1">
                <Demographic @patientData=addNewUser @customEvent="closeNavigationDrawer" @UpdateTab="TabsUpdate"
