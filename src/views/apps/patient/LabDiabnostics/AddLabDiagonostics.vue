...
const onSubmit = async() => {
  ...
  refForm.value?.validate().then(async({ valid }) => {
    ...
    //   console.log('lastnae',lastName.value);
      ...
      store.dispatch('saveLabDiagnostics',
        {
            practitioner_id: practitioner.value,
            location: location.value,
            lab: lab.value,
            courtesy: {
            copy: courtesy.value.copy,
            fax_number: courtesy.value.fax_number,
            fax_attn: courtesy.value.fax_attn,
            account_attn: courtesy.value.account_attn,
            },
            payer: payer.value,
            includeSecIns: includeSecIns.value,
            isWorkersComp: isWorkersComp.value,
            orderPSC: orderPSC.value,
            DiagnosisCode: {
            diagnosisCode: DiagnosisCode.value.diagnosisCode,
            diagnosticTests: DiagnosisCode.value.diagnosticTests,
            },
            orderDetails: {
            priority: orderDetails.value.priority,
            collectionDateTime: orderDetails.value.collectionDateTime,
            collectionDate: orderDetails.value.collectionDate,
            specimenSource: orderDetails.value.specimenSource,
            relevantClinicalInfo: orderDetails.value.relevantClinicalInfo,
            notes: orderDetails.value.notes,
            sourceSiteDetails: orderDetails.value.sourceSiteDetails,
            race: orderDetails.value.race,
            hispanicHeritage: orderDetails.value.hispanicHeritage,
            specimenActionCode: orderDetails.value.specimenActionCode,
            height: orderDetails.value.height,
            weight: orderDetails.value.weight,
            volume: orderDetails.value.volume,
            },
            maternalScreening: {
            insulinDependent: maternalScreening.value.insulinDependent,
            numberOfFetuses: maternalScreening.value.numberOfFetuses,
            otherIndications: maternalScreening.value.otherIndications,
            additionalInfo: maternalScreening.value.additionalInfo,
            donorEgg: maternalScreening.value.donorEgg,
            ageOfDonor: maternalScreening.value.ageOfDonor,
            typeOfEggDonor: maternalScreening.value.typeOfEggDonor,
            gestationalAgeWeeks: maternalScreening.value.gestationalAgeWeeks,
            gestationalAgeDays: maternalScreening.value.gestationalAgeDays,
            gestationalAgeDecimal: maternalScreening.value.gestationalAgeDecimal,
            gestationalAgeDate: maternalScreening.value.gestationalAgeDate,
            crownRumpLength: maternalScreening.value.crownRumpLength,
            sonographerLastName: maternalScreening.value.sonographerLastName,
            sonographerFirstName: maternalScreening.value.sonographerFirstName,
            sonographerId: maternalScreening.value.sonographerId,
            nuchalTranslucency: maternalScreening.value.nuchalTranslucency,
            nuchalTranslucencyTwinB: maternalScreening.value.nuchalTranslucencyTwinB,
            },
            bethesdaCytology: {
            cervix: bethesdaCytology.value.cervix,
            endocervix: bethesdaCytology.value.endocervix,
            labiaVulva: bethesdaCytology.value.labiaVulva,
            vagina: bethesdaCytology.value.vagina,
            endometrium: bethesdaCytology.value.endometrium,
            labiumMajus: bethesdaCytology.value.labiumMajus,
            labiumMinus: bethesdaCytology.value.labiumMinus,
            vulva: bethesdaCytology.value.vulva,
            lmpMenoDate: bethesdaCytology.value.lmpMenoDate,
            none: bethesdaCytology.value.none,
            coniza: bethesdaCytology.value.coniza,
            colpBX: bethesdaCytology.value.colpBX,
            laserVap: bethesdaCytology.value.laserVap,
            cryo: bethesdaCytology.value.cryo,
            radiation: bethesdaCytology.value.radiation,
            datesResults: bethesdaCytology.value.datesResults,
            pregnant: bethesdaCytology.value.pregnant,
            lactating: bethesdaCytology.value.lactating,
            oralContraceptives: bethesdaCytology.value.oralContraceptives,
            menopausal: bethesdaCytology.value.menopausal,
            swabSpatula: bethesdaCytology.value.swabSpatula,
            brushSpatula: bethesdaCytology.value.brushSpatula,
            spatulaAlone: bethesdaCytology.value.spatulaAlone,
            brushAlone: bethesdaCytology.value.brushAlone,
            broomAlone: bethesdaCytology.value.broomAlone,
            otherCollectionTechnique: bethesdaCytology.value.otherCollectionTechnique,
            estroRX: bethesdaCytology.value.estroRX,
            pmpBleeding: bethesdaCytology.value.pmpBleeding,
            postPart: bethesdaCytology.value.postPart,
            iud: bethesdaCytology.value.iud,
            allOtherPat: bethesdaCytology.value.allOtherPat,
            negative: bethesdaCytology.value.negative,
            atypical: bethesdaCytology.value.atypical,
            caInSitu: bethesdaCytology.value.caInSitu,
            invasive: bethesdaCytology.value.invasive,
            otherPreviousInfo: bethesdaCytology.value.otherPreviousInfo,
            hysterectomyTotal: bethesdaCytology.value.hysterectomyTotal,
            hysterectomyPartial: bethesdaCytology.value.hysterectomyPartial,
            dysplasiaLow: bethesdaCytology.value.dysplasiaLow,
            dysplasiaHigh: bethesdaCytology.value.dysplasiaHigh,
            },
            includeElectronicSignature: includeElectronicSignature.value,
            printOrderDetails: printOrderDetails.value,
            emailOrderDetails: emailOrderDetails.value,
            shareRequisitionOnPatientPortal: shareRequisitionOnPatientPortal.value,
        }
      )
    }else{
