...
<template>
  ...
  <PerfectScrollbar :options="{ wheelPropagation: false }">
    ...
    <DataTable ref="dataTable" cardTitle="" :btnTitle="$t('New Intake')" :headers="headers"
    ...
    <VNavigationDrawer v-model="isSelectLabDialogVisible" temporary :width="800" location="end"
      ...
      <AppDrawerHeaderSection :title='"Add Intake Form (" + props.patient.demographic.fullName + ")"'
      ...
      <VCard :title="$t('Intake Form')">
        <VCardText>
          <VForm ref="intakeFormRef">
            <VRow>
              <VCol cols="9">
                <AppSelect v-model="intakeFormId" label="Select Intake Form" placeholder="" :items="formsStore.forms"
    ...
    <VNavigationDrawer v-model="isViewConsentFormDrawerVisible" temporary :width="800" location="end"
      ...
      <AppDrawerHeaderSection :title='"View Intake Form (" + props.patient.demographic.fullName + ")"'
        @cancel="isViewConsentFormDrawerVisible = false" />
      <VDivider />
      <PerfectScrollbar :options="{ wheelPropagation: false }">
        <ViewIntakeForm v-if="isViewConsentFormDrawerVisible" :intakefieldData="intakefieldValue"
    ...
    <VNavigationDrawer v-model="isRequestFormDrawerVisible" temporary :width="800" location="end"
      class="scrollable-content">
      <AppDrawerHeaderSection :title='"Forms Request (" + props.patient.demographic.fullName + ")"'
