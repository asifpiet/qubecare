...
const showEditData = computed(() =>{
  ...
  if(patient){
    insurance.value = store.getters.getPatientPorfile.insurance
    insuredPlanOrProgramName.value = store.getters.getPatientPorfile.insuredPlanOrProgramName
    insuredIDNumber.value =  store.getters.getPatientPorfile.insuredIDNumber
    insuredGroupNameNo.value = store.getters.getPatientPorfile.insuredGroupNameNo
    ...
    coPayment.value = store.getters.getPatientPorfile.coPayment
    coInsurance.value = store.getters.getPatientPorfile.coInsurance
    insuranceDeductible.value =  store.getters.getPatientPorfile.insuranceDeductible
    insuredAddress.value = store.getters.getPatientPorfile.insuredAddress
    ...
    payerID.value = store.getters.getPatientPorfile.payerID
    payerAddress.value = store.getters.getPatientPorfile.payerAddress
    payerCity.value =  store.getters.getPatientPorfile.payerCity
    payerState.value = store.getters.getPatientPorfile.payerState
