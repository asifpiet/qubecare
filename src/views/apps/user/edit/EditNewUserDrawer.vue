<script setup>
import Demographic from '@/views/apps/user/edit/Demographic.vue';
import EligibilityCheck from '@/views/apps/user/edit/EligibilityCheck.vue';
import Insurance from '@/views/apps/user/edit/Insurance.vue';
import NextOfKin from '@/views/apps/user/edit/NextOfKin.vue';
import Payment from '@/views/apps/user/edit/Payment.vue';
import PreAuth from '@/views/apps/user/edit/PreAuth.vue';
import SecInsurance from '@/views/apps/user/edit/SecInsurance.vue';
