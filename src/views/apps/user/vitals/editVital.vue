...
const editVital = computed(async() => {
    // console.log("EditVitalData",props.editVitalData[0]);
    weight_lbs.value = props.editVitalData[0].weight_lbs
    weight_oz.value = props.editVitalData[0].weight_oz
    temperature.value= props.editVitalData[0].temperature
    height_ft.value= props.editVitalData[0].height_ft
    height_in.value= props.editVitalData[0].height_in
    ibm.value= props.editVitalData[0].ibm
    blood_presssure.value= props.editVitalData[0].blood_presssure
    diastolic.value= props.editVitalData[0].diastolic
    respiratory_rate.value= props.editVitalData[0].respiratory_rate
    pulse.value= props.editVitalData[0].pulse
    bloodSugar.value= props.editVitalData[0].bloodSugar
    fasting.value= props.editVitalData[0].fasting
    saturation.value= props.editVitalData[0].saturation
    headCircumference_in.value= props.editVitalData[0].headCircumference_in
    neck_in.value= props.editVitalData[0]. neck_in
    shoulders_in.value= props.editVitalData[0].shoulders_in
    chest_in.value= props.editVitalData[0].chest_in
    waist_in.value= props.editVitalData[0].waist_in
    hips_in.value= props.editVitalData[0]. hips_in
    lean_body_mass_lbs.value= props.editVitalData[0].lean_body_mass_lbs
    left_forearm_in.value= props.editVitalData[0].left_forearm_in
    left_wrist_in.value= props.editVitalData[0].left_wrist_in
    right_forearm_in.value= props.editVitalData[0].right_forearm_in
    right_wrist_in.value= props.editVitalData[0].right_wrist_in
    left_bicep_in.value= props.editVitalData[0].left_bicep_in
    right_bicep_in.value= props.editVitalData[0].right_bicep_in
    left_thigh_in.value= props.editVitalData[0].left_thigh_in
    right_thigh_in.value= props.editVitalData[0].right_thigh_in
    left_calf_in.value= props.editVitalData[0].left_calf_in
    right_calf_in.value= props.editVitalData[0].right_calf_in
    body_fat.value= props.editVitalData[0].body_fat
    activity_level.value= props.editVitalData[0]. activity_level
    hip_to_waist.value= props.editVitalData[0].hip_to_waist
    resting_metabolic_rate_kcal.value= props.editVitalData[0].resting_metabolic_rate_kcal
    with_activity_metabolic_rate_kcal.value= props.editVitalData[0].with_activity_metabolic_rate_kcal
    fluid.value= props.editVitalData[0].fluid
    fluid_oz.value= props.editVitalData[0].fluid_oz
    protein.value= props.editVitalData[0].protein
    protein_gms.value= props.editVitalData[0].protein_gms
    protein_bmi.value= props.editVitalData[0]. protein_bmi
    frame.value= props.editVitalData[0].frame
    ideal_body_weight_lbs.value= props.editVitalData[0].ideal_body_weight_lbs
    ibw_percentage.value= props.editVitalData[0].ibw_percentage
    adjusted_body_weight_abw_lbs.value= props.editVitalData[0].adjusted_body_weight_abw_lbs
    recommendation_weight.value= props.editVitalData[0].recommendation_weight
    notes.value= props.editVitalData[0].notes
    subjective_notes.value= props.editVitalData[0].subjective_notes
    return true;
});
