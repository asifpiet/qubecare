<script setup>
import { getLinePatientChartSimpleConfig } from '@core/libs/apex-chart/apexCharConfig';
import { useTheme } from 'vuetify';
import { useStore } from 'vuex';
const store = useStore()
const vuetifyTheme = useTheme()
const balanceChartConfig = computed(() => getLinePatientChartSimpleConfig(vuetifyTheme.current.value))
const series = ref([{
  data: []
}])
