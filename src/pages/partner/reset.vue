...
refVForm.value?.validate().then(async ({ valid: isValid }) => {
  ...
  if (isValid) {
      ...
      router.replace(route.query.to ? String(route.query.to) : '/partner/login')
        ...
        <VCardText>
          <VForm ref="refVForm" @submit.prevent="onSubmit">
            <VRow>
              ...
              <VCol cols="12">
                <AppTextField
                  v-model="patientStore.passwordReset.passcode"
                  :rules="[requiredValidator,passcodeValidator]"
                   :error-messages="errors.passcode"
                  autofocus
                  label="Passcode"
                  type="number"
                  maxlength="8"
              ...
              <VCol cols="12">
                    <VTextField v-model="patientStore.passwordReset.password" label="Password" placeholder="············"
                ...
                <VCol cols="12">
                    <VTextField v-model="patientStore.passwordReset.password_confirmation" label="Confirm Password" placeholder="············"
