...
const paymentOptions = ref('Take Payment')
const practitioner_fee = ref(0)
const bgColor = ref('#FFFFFF')
const btnColor = ref('#7367f0')
const textColor = ref('#000000')
const builderData = ref(null)
const list = ref([
    "Payment", "Appointment", "Intake", "Questionnaire"
]);
const products = ref([]);
const product = ref([]);
...
const submitForm = async () => {
    ...
    if (valid) {
        ...
        console.log('builderRes', builderData.value)
                        ...
                        <v-card-text>
                            <v-row>
                                <v-col cols="12" md="12">
                                    ...
                                    <VTextField v-model="builder_name" placeholder="e.g. Your Company Name"
                                        :rules="[requiredValidator]" density="comfortable" />
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="12" md="3">
                                    <AppSelect v-model="practitioner" label="Practitioner" :items="practitioners"
                                        item-value="id" item-title="name" :rules="[requiredValidator]" />
                                </v-col>
                                <v-col cols="12" md="3">
                                    <AppSelect v-model="intake" label="Intake" :items="intakes" item-value="id"
                                        item-title="name" multiple clearable />
                                </v-col>
                                <v-col cols="12" md="3">
                                    <AppSelect v-model="questioner" label="Questioner" :items="questioners"
                                        item-value="id" item-title="name" multiple clearable />
                                </v-col>
                                <v-col cols="12" md="3">
                                    <AppSelect v-model="product" label="Products" :items="products" item-value="id"
                                        item-title="name" multiple clearable />
                                </v-col>
                                <v-col cols="12" md="12">
                            ...
                            <v-row>
                                <v-col cols="12" md="3">
                                    ...
                                    <div
                                        class="list-group-item bg-gray-300 m-1 p-3 rounded-md text-center draggable-item-disabled">
                                        Login/Signup
                                    </div>
                                    <div
                                        class="list-group-item bg-gray-300 m-1 p-3 rounded-md text-center draggable-item-disabled">
                                    ...
                                    <VueDraggableNext class="dragArea list-group w-full" :list="list" @end="log"
                                        filter=".nodrag">
                        ...
                        <v-card-text>
                            <v-row>
                                ...
                                <v-col cols="12" md="6">
                                    ...
                                    <VTextField v-model="practitioner_fee" label="" :rules="[requiredValidator]"
                                        density="comfortable" type="number" />
                                </v-col>
                                <v-col cols="12" md="6">
                                    <AppSelect v-model="theme" label="Theme" :items="themes" item-value="id"
