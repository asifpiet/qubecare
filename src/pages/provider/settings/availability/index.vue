                  ...
                  <div style="inline-size: 15.625rem;">
                    ...
                    <VBtn
                        ...
                        <VRow style="padding: 10px;">
                            <VCol cols="12" lg="4">
                                <AppSelect v-model="event.extendedProps.practitioner_id" :label="$t('Practitioner')"
                                    placeholder="" :items="practitionerOptions" item-value="id" item-title="fullName"
                                    @update:model-value='checkAllFilter' />

                            </VCol>
                            <!-- <VCol cols="12" lg="4" style="margin-top: 25px;">
                                <VBtn block prepend-icon="tabler-plus" @click="openDenawer"
                                    v-if="$can('read', 'Availability Add')">
...
@media (max-width: 1279px) {
    body .fc .fc-toolbar-chunk .fc-button-group .fc-drawerToggler-button {
