...
const route = useRoute('provider-invoice-preview-id')
          ...
          <div
            ...
            <div>
              ...
              <h6 class="text-h6 font-weight-regular">
                ...
                <span>{{ dateFormat(invoiceData.invoice.issuedDate) }}</span>
              </h6>

              <!-- 👉 Due Date -->
              <h6 class="text-h6 font-weight-regular" v-if="invoiceData.invoice.status != 'paid'">
                <span>{{ $t('Due Date') }}: </span>
                <span>{{ dateFormat(invoiceData.invoice.dueDate) }}</span>
              </h6>
              <h6 class="text-h6 font-weight-regular" v-if="invoiceData.invoice.status == 'paid'">
                <span>{{ $t('Status') }}: </span>
        ...
        <VCard>
          <VCardText>
            ...
            <div class="d-flex flex-wrap gap-4">
              <VBtn variant="tonal" color="secondary" class="flex-grow-1" @click="printInvoice">
                {{ $t('Print') }}
              </VBtn>

              <VBtn color="secondary" variant="tonal" class="mb-4 flex-grow-1"
                :to="{ name: 'provider-invoice-edit-id', params: { id: route.params.id } }">
                {{ $t('Edit') }}
              </VBtn>
            </div>
