...
const renderForm = async () => {
  let formApi = await $api(GET_REG_FORM_DATA + '/' + props.selectedFormId, {
    method: 'GET',
...
const save = async () => {
  ...
  formData.append('form_id', props.selectedFormId)
  ...
  await formsStore.updateStatus(currentUser.value.id, props.selectedFormId)
  // POST_REQUEST_STATUS
  patientRegStore.submittedForm.push(props.selectedFormId)
