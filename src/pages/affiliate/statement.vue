...
definePage({
    meta: {
        action: 'read',
        subject: 'Affiliate Statements View',
    },
})

import { useRouter } from 'vue-router';
import { generateMultipleStatementsPDF } from '../partner/statementGen';
import StatementTemplate from '../partner/StatementTemplate.vue';
...
<template>
    ...
    <DataTable ref="dataTable" :cardTitle="$t('Statements')" btnTitle="" :headers="headers" :api="GET_AFFILIATE_STATEMENTS"
        :sortBy="sortByData">
