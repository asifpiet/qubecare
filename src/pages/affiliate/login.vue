...
const handleSubmit = async () => {
    ...
    try {
        ...
        hideLoader()
        await nextTick(() => {
            router.replace(route.query.to ? String(route.query.to) : '/affiliate/dashboard')
        })
    } catch (err) {
        hideLoader()
    ...
    <div class="container">
        ...
        <div class="left-panel">
            <div class="branding">
                ...
                <h1 class="tagline">{{ $t('Expand Your Practice Through Our Affiliate Program') }}</h1>
                <p class="description">
                    {{ $t(`Join fellow chiropractors who are enhancing patient care while generating additional revenue
                    streams for their practice.`) }}
                ...
                <div class="benefits">
                    <div class="benefit-item">
                        ...
                        <div class="benefit-text">
                            {{ $t('Refer patients to complementary services') }}
                        </div>
                    </div>
                    <div class="benefit-item">
                        <div class="benefit-icon">
            ...
            <div class="testimonial">
                <p class="testimonial-quote">
                    {{ $t('As a chiropractor, affiliating with QubeCare has been a game-changer.') }}
        ...
        <div class="right-panel">
            ...
            <div class="form-header">
                <h2 class="form-title">{{ $t('Qube Affiliate Portal') }}</h2>
            ...
            <VForm ref="refVForm" @submit.prevent="onSubmit" class="login-form">
                ...
                <div class="form-options">
                    ...
                    <router-link :to="'/affiliate/forgot'" class="forgot-password">
                ...
                <!-- <div class="signup-link">
                    {{ $t('New to our partner program?') }} <router-link :to="'/affiliate/register'"
