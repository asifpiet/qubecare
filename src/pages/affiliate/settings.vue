...
let user = await affiliateAuthService.fetchProfile()
...
onMounted(async () => {
    ...
    address.value = affiliateStore.affiliateAccount?.address ?? null;
    bank_name.value = affiliateStore.affiliateAccount?.bank_name ?? null;
    account_type.value = affiliateStore.affiliateAccount?.account_type ?? 'checking';
    email_notifications.value = affiliateStore.affiliateAccount?.email_notifications ?? false;
    payment_alerts.value = affiliateStore.affiliateAccount?.payment_alerts ?? false;
    refferal_updates.value = affiliateStore.affiliateAccount?.refferal_updates ?? false;
    sms_notifications.value = affiliateStore.affiliateAccount?.sms_notifications ?? false;
});
...
const updateProfile = async () => {
    await affiliateStore.updateProfile(
        {
