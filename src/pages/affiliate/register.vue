...
const register = async () => {
    ...
    let dataForm = {
        ...
        partner_email: localStorage.getItem('partner_email')
    }
    showLoader()
    try {
        await authService.value.register(dataForm);
        await router.push({ name: 'affiliate-dashboard' });
    } catch (e) {
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="login-link">
                {{ $t('Already have an account?') }} <router-link :to="'/affiliate/login'">{{ $t('Sign In')
                }}</router-link>
            </div>
        </div>
        ...
        <div class="signup-container">
            <div class="signup-sidebar">
                <div class="sidebar-content">
                    <h2 class="signup-title">{{ $t('Join Our Affiliate Network') }}</h2>
                    <p>
                        {{ $t(`Complete the registration process to get started with QubeCare's affiliation program`) }}
                    </p>
                    ...
                    <div class="step-guide">
                        ...
                        <p class="step-guide-text">
                            {{ $t(`As an affiliate, you'll gain access to additional revenue`) }}
                            {{ $t('streams while providing more comprehensive care options for your patients.') }}
                        </p>
                    </div>
                    ...
                    <div class="signup-support">
                        ...
                        <p class="support-text">
                            {{ $t('Our partner support team is available to assist you with your registration.') }}
                            .</p>
                        <div class="support-contact">
                            <span class="support-icon"><i class="fas fa-envelope"></i></span>
                            affiliates@qubecare.com
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="signup-form-container">
                ...
                <div class="form-header">
                    <h1 class="form-title">{{ $t('Create Your Affiliate Account') }}</h1>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <VTextField v-model="email" label="" type="email"
                                    ...
                                    density="comfortable" />
                                <div class="input-hint">{{ $t(`We'll send verification and updates to this email`) }}</div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <v-date-input v-model="dob" :max="getCurrentDate()" :rules="[requiredValidator]"
                                    :error-messages="errors.dob" label="" :placeholder="$t('Date of Birth')" prepend-icon=""
                                    variant="outlined" density="comfortable" ok-text="OK"
