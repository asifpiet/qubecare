...
export const getLineChartSimpleConfig = themeColors => {
  ...
  return {
    ...
    xaxis: {
      ...
      categories: store.getters.getAffiliateDashbardStats.line_chart.labels,
    },
  }
}
export const getBarChartConfig = themeColors => {
  ...
  return {
    ...
    xaxis: {
      axisBorder: { show: false },
      axisTicks: { color: themeBorderColor },
      categories: ['Provider1','Provider 2'],
      labels: {
        style: { colors: themeDisabledTextColor, fontSize: '0.8125rem' },
      },
    },
...
export const getDonutChartConfig = themeColors => {
  ...
  return {
    stroke: { width: 0 },
    labels: ['Initial Consultation', 'Follow-up Session', 'Group Session', 'Other'],
