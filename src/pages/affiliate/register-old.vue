...
<template>
  ...
  <VRow style="min-height: 101.7dvh; max-height: 101.7dvh; margin: 0px;"
    ...
    <VCol cols="12" md="6" class="bg-custom col-order-1"
      :class="isMobile ? 'd-none' : 'auth-wrapper d-flex align-center justify-center pa-4'">
      <DefinedSteps></DefinedSteps>
    </VCol>
    <VCol cols="12" md="6" class="bg-custom-color col-order-2" :class="isMobile ? '' : 'pa-4'">
      <VCard class="auth-card pa-2 rounded-5" :class="isMobile ? 'second-card' : 'card-margin '">
        <VCardItem class="py-2">
          <h4 class="text-h4 mb-1 text-left mb-4">
            Basic Information
          </h4>
        </VCardItem>
        <VCardText>
          ...
          <VForm ref="refVForm" @submit.prevent="onSubmit">
            <VRow>
              ...
              <!-- <VCol cols="12">
                <VTextField v-model="password" label="Password" placeholder="············" :rules="[requiredValidator]"
            ...
            <VRow>
              ...
              <VCol cols="12" class="text-right">
                ...
                <router-link :to="'/affiliate/login'" class="text-primary underline">Sign In</router-link>
