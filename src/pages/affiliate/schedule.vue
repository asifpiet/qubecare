            ...
            <VContainer :class="isMobile ? 'px-0 container-mobile' : ''">
                ...
                <div v-if="!isMobile">
                    <VRow>
                                ...
                                <div>
                                    ...
                                    <div class="text-center mt-6">
                                        <span class="visit-type">
                                            {{ $t('Virtual Telehealth Visit • {duration}', { duration: slotDuration })
                                            }}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <VCol cols="12" md="7">
                            <div class="scheduler">
                                <DateCalendar :data="appointmentObject" :doctorName="doctorName" :affiliate="true"
                                    @update:slotDuration="updateSlotDuration">
                                </DateCalendar>
                            </div>
                        </VCol>
                    </VRow>
